Release Summary for Version 0.4.0 (December 1, 2024) - Crawl4AI Documentation (v0.4.3bx)
...
Affected Files:
crawl4ai/content\_filter\_strategy.py
: Added a scoring-based pruning algorithm.
README.md
: Updated to include PruningContentFilter usage.
docs/md\_v2/basic/content\_filtering.md
: Expanded user documentation, detailing the use and benefits of PruningContentFilter.
...
Affected Files:
tests/async/test\_content\_filter\_prune.py
: Created tests covering different pruning scenarios to ensure stability and correctness.
...
Affected Files:
tests/async/test\_content\_filter\_bm25.py
...
Affected Files:
docs/examples/quickstart\_async.py
: Enhanced example clarity and usability for new users.
