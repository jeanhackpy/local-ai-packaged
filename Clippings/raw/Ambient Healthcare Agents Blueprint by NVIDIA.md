---
title: "Ambient Healthcare Agents Blueprint by NVIDIA"
source: "https://build.nvidia.com/nvidia/ambient-healthcare-agents"
author:
published:
created: 2026-04-05
description: "Build advanced AI agents for providers and patients using this developer example powered by NeMo Microservices, NVIDIA Nemotron, Riva ASR and TTS, and NVIDIA LLM NIM"
tags:
  - "clippings"
---
j

![](https://build.nvidia.com/_next/image?url=https%3A%2F%2Fassets.ngc.nvidia.com%2Fproducts%2Fapi-catalog%2Fimages%2Fambient-healthcare-agents.jpg&w=3840&q=75)
...
[llama-3\_3-nemotron-super-49b-v1](https://build.nvidia.com/nvidia/llama-3_3-nemotron-super-49b-v1) [llama-3\_3-70b-instruct](https://build.nvidia.com/meta/llama-3_3-70b-instruct) [llama-3\_1-nemoguard-8b-content-safety](https://build.nvidia.com/nvidia/llama-3_1-nemoguard-8b-content-safety) [llama-3\_1-nemoguard-8b-topic-control](https://build.nvidia.com/nvidia/llama-3_1-nemoguard-8b-topic-control) [parakeet-ctc-1\_1b-asr](https://build.nvidia.com/nvidia/parakeet-ctc-1_1b-asr) [magpie-tts-multilingual](https://build.nvidia.com/nvidia/magpie-tts-multilingual)

[NVIDIA AI](https://build.nvidia.com/blueprints?filters=blueprintType%3Ablueprinttype_nvidia_ai) [llm](https://build.nvidia.com/blueprints?label=llm) [nemo](https://build.nvidia.com/blueprints?label=nemo) [nim](https://build.nvidia.com/blueprints?label=nim)
...
[![](https://assets.ngc.nvidia.com/products/api-catalog/ambient-healthcare-agents/diagram.jpg)](https://assets.ngc.nvidia.com/products/api-catalog/ambient-healthcare-agents/diagram.jpg)
...
- [llama-3.3-nemotron-super-49b-instruct](https://build.nvidia.com/nvidia/llama-3_3-nemotron-super-49b-v1)
- [llama-3\_3-70b-instruct](https://build.nvidia.com/meta/llama-3_3-70b-instruct)
- [llama-3\_1-nemoguard-8b-content-safety](https://build.nvidia.com/nvidia/llama-3_1-nemoguard-8b-content-safety)
- [llama-3\_1-nemoguard-8b-topic-control](https://build.nvidia.com/nvidia/llama-3_1-nemoguard-8b-topic-control)
- [parakeet-ctc-1\_1b-asr](https://build.nvidia.com/nvidia/parakeet-ctc-1_1b-asr)
...
| [Reasoning Model](https://docs.nvidia.com/nim/large-language-models/latest/supported-models.html#llama-33-nemotron-super-49b-v1) | Medical Note (SOAP) Generation | 2x H100 80 GB   *or* 4x A100 80 GB |
...
| [Instruct Model](https://docs.nvidia.com/nim/large-language-models/latest/supported-models.html#llama-33-70b-instruct) | Agent Reasoning   and Tool Calling | 2x H100 80 GB   *or* 4x A100 80GB (see [modelcard](https://docs.nvidia.com/nim/large-language-models/latest/supported-models.html#llama-33-70b-instruct)) |
...
- Vulnerability Reporting: If you discover any security issues or vulnerabilities in this repository, please follow the reporting instructions in the [SECURITY.md](https://github.com/NVIDIA-AI-Blueprints/ambient-healthcare-agents/blob/main/SECURITY.md) file.

For more information, see the [SECURITY.md](https://github.com/NVIDIA-AI-Blueprints/ambient-healthcare-agents/blob/main/SECURITY.md) file in the developer example repository.
