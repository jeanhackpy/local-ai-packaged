...
class Pipe:
    ...
    async def pipe(
        ...
        # PERFORMANCE OPTIMIZATION: Fast-path for short queries (< 15 chars)
        # Bypasses LLM-based difficulty evaluation to save latency.
    ...
    async def evaluate_difficulty(self, query: str) -> str:
        ...
        try:
            payload = {
                ...
                "options": {
                    "temperature": 0,
                    "num_predict": 5 # Limit output to 5 tokens for classification
                }
            }
