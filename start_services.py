...
def prepare_openclaw_config():
    """Inject tokens into openclaw/openclaw.json from root .env."""
    root_env_path = ".env"
    ...
    if not gateway_token:
        ...
        print("Generated and added OPENCLAW_GATEWAY_TOKEN to .env")
    ...
    print(f"Successfully prepared {target_config_path}")
