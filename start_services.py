...
def prepare_openclaw_config():
    ...
    # Always read from example to ensure placeholders are available for replacement
    # and that changes in .env are reflected in the generated config.
    if not os.path.exists(example_path):
        print(f"Warning: OpenClaw example config not found at {example_path}")
        return
    ...
    # Replace placeholders and write to the real config file
